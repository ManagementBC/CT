...
contract ManagementContract {
    ...
    address public immutable manager; // This represents the sponsor/manager of the smart contract
    ...
    constructor(address _regulator) {
        require(_regulator != address(0), "Regulator cannot be the zero address");
        manager = msg.sender;
